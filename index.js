 ...
 */
var Ng2EmojiService = /** @class */ (function () {
    function Ng2EmojiService() {
    }
    ...
    Ng2EmojiService.decorators = [
        { type: Injectable },
    ];
    /** @nocollapse */
    Ng2EmojiService.ctorParameters = function () { return []; };
    return Ng2EmojiService;
}());
...
var Ng2EmojiPipe = /** @class */ (function () {
     ...
     * @return {?}
     */
    Ng2EmojiPipe.prototype.transform = /**
     * @param {?} value
     * @param {?} args
     * @return {?}
     */
    function (value, args) {
        ...
        return this._sanitizer.bypassSecurityTrustHtml(value.replace(Ng2EmojiService.emojisRegex, (/**
         * @param {?} match
         * @param {?} text
         * @return {?}
         */
    ...
    Ng2EmojiPipe.decorators = [
        { type: Pipe, args: [{
                    name: 'emojis'
                },] },
    ];
    /** @nocollapse */
    Ng2EmojiPipe.ctorParameters = function () { return [
        { type: DomSanitizer }
    ]; };
    return Ng2EmojiPipe;
}());
